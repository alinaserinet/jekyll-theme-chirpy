...
زبان ها: فارسی | [English](https://github.com/alinaserinet/jekyll-theme-chirpy/blob/master/docs/README.en.md) | [简体中文](https://github.com/alinaserinet/jekyll-theme-chirpy/blob/master/docs/README.zh-CN.md)
...
- تنظیم حالت تم
- دسته هایی با دو سطح
- تاریخ برای آخرین تغییرات پست
- فهرست مطالب
- پیشنهاد خودکار پست های مرتبط
- عبارت‌های ریاضی
- رسم دیاگرام و فلوچارت
- جستجو
- Atom Feeds
- نظرات
- Google Analytics
